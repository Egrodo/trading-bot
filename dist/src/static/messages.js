...
const messages = {
    ...
    checkBalance: (balance, user) => `${user ? user : ''} ${user ? 'has' : 'You have'} a balance of ${balance}.`,
    ...
    notEnoughMoneyForBuy: (balance, ticker, price, totalAmount) => `${messages.notEnoughMoney(balance)} ${ticker} is at ${price}, so you would need ${totalAmount} to do this.`,
