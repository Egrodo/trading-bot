const messages = {
  ...
  notEnoughMoney: (balance) =>
    `Sorry, you don't have enough money in your account for this operation. ${messages.checkBalance(balance)}`,
  moneyGranted: (user, amount, balance) =>
    `Congrats ${user}, you've been granted ${amount}. ${messages.checkBalance(balance)}`,
